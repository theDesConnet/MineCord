...
class Command {
    /**
     * @typedef {{name: string, description: string, permissions: Discord.PermissionString, onlyBotOwner: Boolean, slashCommandOptions: Discord.ApplicationCommandOption[] execute: ExecuteFuctions}} CommandOptions
